...
#define FIREBASE_HOST "greenleaf-63767.firebaseio.com"
#define FIREBASE_AUTH "VpKjMH2Ao8RYj27aeOyKI7JXTECAGfSDo7msJT51"
#define WIFI_SSID "Familie Yde WiFi"
#define WIFI_PASSWORD "ytn8263@yde" //no password
...
//#define FIREBASE_HOST "greenleaf-63767.firebaseio.com"
#define FIREBASE_HOST "greenleaf-63767-default-rtdb.europe-west1.firebasedatabase.app"
#define FIREBASE_AUTH "LEVU3neJM4T3CQlD0mPVMRehyRSH8hAXJR8IRnDk"
...
void setup() {
  ...
  if (!Firebase.setDouble(firebaseData, "/test", 69.420)) {
 ...
 /*
  *  FirebaseJson json;
  json.add("name", "Water turbine 1");
  json.add("production", 120);
  json.add("health", 1.0);
  ...
  Firebase.updateNode(firebaseData, "/test/update", json);
...
void setup() {
  ...
  Serial.begin(115200);  
  bluetooth.begin("ESP32 - RAINWATER");
}
...
void loop() {
  if (notify) {
    String message = "{'update': {'motion': ";
    message += motion ? "true" : "false";
    message += "}}";
